...
import com.global.hr.service.BookService;
...
public class BookController {
    ...
    @GetMapping("/book/{id}")
    public Optional<Book> getById(@PathVariable("id") Long bookId) throws BookNotFoundException {
    ...
    public void delete(@PathVariable("id") Long bookId) throws BookNotFoundException {
